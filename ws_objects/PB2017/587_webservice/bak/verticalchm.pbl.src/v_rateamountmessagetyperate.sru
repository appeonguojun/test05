$PBExportHeader$v_rateamountmessagetyperate.sru
$PBExportComments$Proxy imported from Web service using Web Service Proxy Generator.
forward
    global type V_RateAmountMessageTypeRate from V_RateUploadType
    end type
end forward
...
on V_RateAmountMessageTypeRate.create
call super::create
TriggerEvent( this, "constructor" )
end on

on V_RateAmountMessageTypeRate.destroy
