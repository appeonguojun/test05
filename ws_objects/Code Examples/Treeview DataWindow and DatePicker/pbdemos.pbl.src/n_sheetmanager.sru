$PBExportHeader$n_sheetmanager.sru
$PBExportComments$Generated MDI Sheet Management
forward
global type n_sheetmanager from nonvisualobject
end type
end forward

global type n_sheetmanager from nonvisualobject
end type
global n_sheetmanager n_sheetmanager

type variables
string is_sheets[], is_display[]
w_basesheet iw_opensheets[]
menu im_items[]
end variables
...
public function long of_sheetisclosing (readonly w_basesheet aw_sheet)
...
li_rc = OpenSheet ( lw_sheet, as_sheetname, w_frame, 0, Layered! ) 
...
on n_sheetmanager.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_sheetmanager.destroy
