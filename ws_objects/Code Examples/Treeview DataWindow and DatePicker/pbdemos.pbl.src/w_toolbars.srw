...
type cb_done from commandbutton within w_toolbars
end type
...
type gb_options from groupbox within w_toolbars
end type
end forward
...
/* Conditional Compile Code Block Example
Disable the Floating Toolbar option if 
this is a .NET Deployment */
#if defined PBDOTNET then
	rb_floating.enabled = False
#else
	rb_floating.enabled = True
#end if
