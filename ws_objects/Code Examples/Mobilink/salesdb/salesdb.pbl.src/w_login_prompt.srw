...
//  Since we have already done all the hard work parsing the dbparm, let's 
//  assume these connectstring values will also be used for synchronization.
g_syncparms.DBuser = i_uid
g_syncparms.DBpass= i_pwd
g_syncparms.encryptionkey = i_dbkey
