$PBExportHeader$w_smarttool_syncprogress.srw
$PBExportComments$Window for running dbmlsync
forward
global type w_smarttool_syncprogress from window
end type
type st_phasebar from statictext within w_smarttool_syncprogress
end type
type hpb_progress from hprogressbar within w_smarttool_syncprogress
end type
type mle_status from multilineedit within w_smarttool_syncprogress
end type
type cb_ok from commandbutton within w_smarttool_syncprogress
end type
type cb_cancel from commandbutton within w_smarttool_syncprogress
end type
end forward
...
global w_smarttool_syncprogress w_smarttool_syncprogress
...
on w_smarttool_syncprogress.create
...
on w_smarttool_syncprogress.destroy
...
if IsValid(i_uosync) and i_uosync.TypeOf() = MlSync! then
	...
	'OpenWithParm(w_smarttool_syncprogress, instance_of_MLSync!)~r~n'
end if
