HA$PBExportHeader$w_testvss_frame.srw
$PBExportComments$Generated MDI Frame
forward
global type w_testvss_frame from window
end type
type mdi_1 from mdiclient within w_testvss_frame
end type
end forward
...
string title = "Frame"
string menuname = "m_testvss_frame"
...
global w_testvss_frame w_testvss_frame

type variables
n_testvss_sheetmanager inv_sheetmgt
end variables

forward prototypes
public function long of_getsheetcount ()
public function integer of_sheetisclosing (readonly w_testvss_basesheet aw_sheet)
...
string ls_sheets[]  = { "w_testvss_sheet1", "w_testvss_sheet2", "w_testvss_sheet3" }
...
inv_sheetmgt = Create n_testvss_sheetmanager

this.Post Event ue_postopen ( )
end event

on w_testvss_frame.create
if this.MenuName = "m_testvss_frame" then this.MenuID = create m_testvss_frame
this.mdi_1=create mdi_1
this.Control[]={this.mdi_1}
end on

on w_testvss_frame.destroy
